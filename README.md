...
```
cd existing_repo
git remote add origin https://gitlab.univ-nantes.fr/mottu-jm/butinfo-gpo2-projet-2022.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.univ-nantes.fr/mottu-jm/butinfo-gpo2-projet-2022/-/settings/integrations)
